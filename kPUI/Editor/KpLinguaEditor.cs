...
namespace KpUi.Editor
{
    ...
    public class KpLinguaEditor : BaseKpEditor
    {
        protected override void Init()
        {
            base.Init();
            
            using (var stream = new MemoryStream(kPUI.Properties.Resources.KpLinguaSyntaxHighlighting))
            {
        ...
        public override void Save()
        {
            if (!HasAssociatedFile)
            {
                ...
                opd.Filter = "kP Lingua file (*.kpl)|*.kpl";
